 ...
 *       &lt;sequence>
 *         &lt;element name="items" type="{http://ws.adapter.introsde/}itemActivity" maxOccurs="unbounded" minOccurs="0"/>
...
public class Activities {
    ...
    protected List<ItemActivity> items;
    protected int size;
    ...
    public List<ItemActivity> getItems() {
        if (items == null) {
            items = new ArrayList<ItemActivity>();
        }
        return this.items;
    }

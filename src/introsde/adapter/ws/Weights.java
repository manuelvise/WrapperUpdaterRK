 ...
 *       &lt;sequence>
 *         &lt;element name="items" type="{http://ws.adapter.introsde/}itemWeight" maxOccurs="unbounded" minOccurs="0"/>
...
public class Weights {
    ...
    protected List<ItemWeight> items;
     ...
     * 
     */
    public List<ItemWeight> getItems() {
        if (items == null) {
            items = new ArrayList<ItemWeight>();
        }
        return this.items;
    }

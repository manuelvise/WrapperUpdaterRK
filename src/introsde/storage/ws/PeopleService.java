 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.storage.introsde/", wsdlLocation = "http://localhost:6903/ws/lfcoach?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws.storage.introsde/", "PeopleService");
